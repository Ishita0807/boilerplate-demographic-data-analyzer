...
def calculate_demographic_data(print_data=True):
    ...
    lower_education_rich = round(((fifty_k_low.size/higher_education_df.size)*100),1)
    ...
    high_earn_perctange = 100*df[df.salary=='>50K']['native-country'].value_counts()/df['native-country'].value_counts()
    highest_earning_country = high_earn_perctange.idxmax()
    highest_earning_country_percentage = round(high_earn_perctange.max(),1)
